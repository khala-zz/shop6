...
<div class="form-group {{ $errors->has('title') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="title" type="text"  value="{{ isset($banner->title) ? $banner->title : old('title')}}" required>
    {!! $errors->first('title', '<p class="help-block">:message</p>') !!}
</div>

<!-- tên banner 2-->
<div class="form-group {{ $errors->has('nametwo') ? 'has-error' : ''}}">
    <label for="nametwo" class="control-label">{{ 'Tên Banner 2' }}</label>
    <input class="form-control" name="nametwo" type="text"  value="{{ isset($banner->nametwo) ? $banner->nametwo : old('nametwo')}}" required>
...
<div class="form-group {{ $errors->has('link') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="link" type="text"  value="{{ isset($banner->link) ? $banner->link : old('link')}}" >
