                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <td>
                                @if($item -> is_active == 1)
                                    <a href="{{ url('/khalaadmin/categories/xuly/' . $item -> id.'/0') }}" title="Đang hiển thị"><button class="btn btn-success btn-sm"> Đang hiển thị</button></a>
                                @else
                                    <a href="{{ url('/khalaadmin/categories/xuly/' . $item -> id.'/1') }}" title="Chưa hiển thị"><button class="btn btn-warning btn-sm"> Chưa hiển thị</button></a>
                                @endif
                            </td>
