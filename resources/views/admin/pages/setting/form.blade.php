...
<div class="form-group {{ $errors->has('setting_key') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="setting_key" type="text" id="setting_key" value="{{ isset($setting->setting_key) ? $setting->setting_key : old('setting_key')}}" {{ isset($setting->setting_key) ? "readonly" : "" }} required>
