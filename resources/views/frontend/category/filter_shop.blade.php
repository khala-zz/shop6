                            ...
                            @if($item -> parent == null) 
                                @if(count($item -> children))
                                    <li class="toggle-content">
                                        <a href="{{ url('danh-muc-san-pham/'.slugify($item -> title,'-').'/'.$item -> id) }}" class="{{Request::get('category_id') == $item -> id ?'active-khala':''}}">{{$item->title}}<span class="caret"></span></a>
                                ...
                                @else
                                    ...
                                    <li >
                                        <a href="{{ url('danh-muc-san-pham/'.slugify($item -> title,'-').'/'.$item -> id) }}" class="{{Request::get('category_id') == $item -> id ?'active-khala':''}}">{{$item->title}}</a>
