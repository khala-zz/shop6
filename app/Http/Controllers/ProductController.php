...
class ProductController extends Controller
{
	...
	public function detail($slug, $id)
	{
    	...
    	//get product detail
		$product = $this -> product -> with('gallery') ->  where('id',$id) -> first();
	...
	public function viewCart(){
		...
		foreach($userCart as $key => $products){
			...
			$userCart[$key] -> cat_title = $productDetail -> category -> title;
			$userCart[$key] -> cat_id = $productDetail -> category -> id;
		}
		//dd($userCart);
	...
	public function order(Request $request){
        ...
        $order -> shipping_charges = $data['shipping_method'];
        $order -> save();
